...
// 読み込むファイルのリスト生成
async function makeFileList(inputPath: string){
...
class JsToUpsidedown {
    ...
    static #laodCharSet(){
        ...
        const json = JSON.parse(text) as USDCharSetType;
    ...
    // 配列の中から最長の横幅を返す
    static #getMaxWidth(lines: Array<string>){
        let result = 0;
